                ...
                <div class="admin-card-header">
                    ...
                    <div class="admin-header-content">
                        <div class="admin-header-text">
                            ...
                            <p class="admin-card-subtitle">Detalhes da cor</p>
                        </div>
                        
                        <div class="admin-header-actions">
                            <a href="{{ route('admin.colors.edit', $color) }}" class="admin-btn admin-btn-primary">
                ...
                <div class="admin-card-body">
                    <div class="admin-info-grid">
                        <div class="admin-info-item">
                            ...
                            <div class="admin-info-value">{{ $color->name }}</div>
                        </div>
                        
                        <div class="admin-info-item">
                            <div class="admin-info-label">Código Hexadecimal</div>
                            <div class="admin-info-value">{{ $color->hex_code ?? '-' }}</div>
                        </div>
                        ...
                        <div class="admin-info-item">
                            <div class="admin-info-label">Visualização</div>
                            <div class="admin-info-value">
                                <div class="admin-color-display">
                                    <span class="admin-color-swatch-large" style="background: {{ $color->hex_code ?? '#eee' }};"></span>
                                    <span class="admin-color-code">{{ $color->hex_code ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="admin-card">
                    <div class="admin-card-body">
                        <div class="admin-empty-state">
                            ...
                            <p>Esta cor ainda não está associada a nenhum produto.</p>
                        </div>
                    </div>
                </div>
            @endif
                ...
                <div class="admin-card-body">
                    <div class="admin-meta-grid">
                        <div class="admin-meta-item">
                            ...
                            <span class="admin-meta-value">{{ $color->created_at->format('d/m/Y H:i') }}</span>
                        </div>
                        <div class="admin-meta-item">
                            <ion-icon name="time-outline"></ion-icon>
                            <span class="admin-meta-label">Última atualização:</span>
                            <span class="admin-meta-value">{{ $color->updated_at->format('d/m/Y H:i') }}</span>
                        </div>
                    </div>
                </div>
            </div>
