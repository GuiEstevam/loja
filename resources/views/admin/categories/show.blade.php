...
@section('content')
  <div class="max-w-7xl mx-auto py-8 px-2 md:px-0">
    <div class="bg-white shadow rounded-lg p-6 md:p-8">
      ...
      <h1 class="text-3xl font-bold mb-2 text-center md:text-left">Produtos da categoria "{{ $category->name }}"</h1>
      <p class="text-gray-600 mb-6 text-center md:text-left">Todos os produtos relacionados a esta categoria</p>
