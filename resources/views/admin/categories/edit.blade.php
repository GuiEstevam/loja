    ...
    <div class="admin-content">
        <div class="admin-container">
          ...
          Dashboard
                    ...
                    <p class="admin-card-subtitle">Modifique as informações da categoria</p>
                </div>
    </div>
                    ...
                    <div class="admin-advanced-actions">
                        ...
                        <div class="admin-action-item">
                            <div class="admin-action-info">
                                ...
                                <p>Esta ação não pode ser desfeita. Todos os produtos associados a esta categoria serão desassociados.</p>
                                @if($category->products->count() > 0)
                                    <div class="admin-warning">
                                        <ion-icon name="warning-outline"></ion-icon>
                                        <strong>Atenção:</strong> Esta categoria possui {{ $category->products->count() }} produto(s) associado(s).
                                    </div>
                                @endif
                            </div>
                            <div class="admin-action-button">
                                <form method="POST" action="{{ route('admin.categories.destroy', $category) }}" class="admin-action-form">
                                    @csrf 
                                    @method('DELETE')
                                    <button type="button" 
        ...
        <div class="admin-modal-body">
            <div class="admin-warning-large">
                ...
                <div>
                    ...
                    <p>Tem certeza que deseja excluir permanentemente a categoria <strong id="deleteItemName"></strong>?</p>
                    <div class="admin-warning-details">
                        <p>• Todos os produtos associados a esta categoria serão desassociados</p>
